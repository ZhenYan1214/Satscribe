  ...
  <div class="article-detail min-h-screen text-white bg-gradient-to-br from-web3-dark via-web3-navy to-web3-darker">
    ...
    <div v-else-if="article" class="max-w-4xl mx-auto px-4 py-8">
        ...
        <div class="flex items-center justify-between mb-6">
          <div class="flex items-center space-x-4">
            ...
            <div>
              ...
              <p class="text-white/60 text-sm">{{ article.author.subscribers }} 訂閱者</p>
            </div>
          </div>
      ...
      <main class="prose prose-lg prose-invert max-w-none mb-12">
        ...
        <div class="text-white/90 leading-relaxed space-y-6">
          <p>這裡是文章的主要內容。在實際應用中，這將是從後端獲取的完整文章內容，支援 Markdown 格式或富文本編輯器。</p>
          
          <h2 class="text-2xl font-bold text-white mt-8 mb-4">Web3 創作者經濟的變革</h2>
          <p>傳統的創作者經濟模式往往由中心化平台主導，創作者只能獲得一小部分收益。而 Web3 技術的出現，為創作者帶來了全新的可能性...</p>
          
          <h3 class="text-xl font-bold text-white mt-6 mb-3">區塊鏈技術的優勢</h3>
          ...
          <p>通過智慧合約，創作者可以設定自動化的分潤規則，確保每一位參與者都能獲得公平的回報。這種模式不僅提高了效率，也增強了信任度。</p>
        </div>
      </main>

      <!-- Article Tags -->
      <div v-if="article.tags && article.tags.length > 0" class="mb-8">
        <h3 class="text-white font-medium mb-4">相關標籤</h3>
      ...
      <div class="bg-gradient-to-r from-web3-purple/20 to-web3-cyan/20 rounded-2xl p-8 mb-8 border border-web3-purple/30">
        <div class="text-center">
          <h3 class="text-2xl font-bold text-white mb-4">支持這位創作者</h3>
          <p class="text-white/80 mb-6">購買訂閱章 NFT，成為這位創作者的支持者</p>
      ...
      <!-- Related Articles -->
      <section>
        <h3 class="text-2xl font-bold text-white mb-6">相關文章</h3>
        <div class="grid md:grid-cols-2 gap-6">
          <!-- 這裡可以放置相關文章的卡片 -->
          <div class="bg-glass-dark rounded-xl p-6 border border-white/10">
            <h4 class="text-white font-bold mb-2">即將推出更多相關內容</h4>
            <p class="text-white/70 text-sm">探索更多來自優質創作者的精彩內容</p>
          </div>
        </div>
      </section>
    </div>
    ...
    <div v-else class="flex items-center justify-center min-h-screen">
      <div class="text-center">
        ...
        <h3 class="text-xl font-bold text-white mb-2">文章未找到</h3>
        <p class="text-white/70 mb-4">您要查看的文章不存在或已被移除</p>
        <button 
          @click="goBack"
...
export default {
  ...
  setup() {
    ...
    const mockArticle = {
      id: 'featured-1',
      title: 'Web3 創作者經濟的未來：從傳統平台到去中心化創作',
      excerpt: '探索 Web3 如何重新定義創作者經濟，從內容創作到價值分配的全新模式。了解區塊鏈技術如何賦予創作者真正的自主權和公平的收益分配。',
      content: '完整的文章內容將在這裡顯示...',
      category: '區塊鏈趨勢',
      author: {
        id: 'author-1',
        name: 'Alice Chen',
