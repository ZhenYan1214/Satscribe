      ...
      <div class="p-6 flex flex-col flex-1">
        ...
        <div class="flex items-center space-x-3 mb-4">
          ...
          <div class="flex-1 min-w-0">
            ...
            <p class="text-web3-gray-400 text-xs">{{ formatNumber(article.author.subscribers) }} Subscriber</p>
          </div>
        ...
        <div class="flex-1 min-w-0 flex flex-col">
          ...
          <div class="flex items-center space-x-3 mb-4">
            ...
            <div class="flex items-center space-x-2">
              ...
              <span class="text-web3-gray-400 text-xs">{{ formatNumber(article.author.subscribers) }} Subscribe</span>
            </div>
